...
describe("Customer Fetch Suit (GET /customers/fetch)", () => {
    before(function () {
    ...
    describe("Logged in from Superadmin", () => {
        it("fetch customers, httpcode #200", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("fetch customers, companyName, httpcode #200", () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield supertest_1.default(main_1.default)
                .get(`/customers/fetch?filter[companyName]=add`)
                .set("user-agent", "mocha")
                .set("Authorization", SUPERADMIN_ACCESS_TOKEN)
                .send(updateCustomerUserData);
            chai_1.expect(result.statusCode).to.equal(200);
        }));
        it("fetch customers, companyName1,  httpcode #200", () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield supertest_1.default(main_1.default)
                .get(`/customers/fetch?filter[companyName1]=add`)
                .set("user-agent", "mocha")
                .set("Authorization", SUPERADMIN_ACCESS_TOKEN)
                .send(updateCustomerUserData);
