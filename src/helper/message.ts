export default {
  ...
  TEAM_MEMBER_IS_NOT_ASSIGN_TO_COMPNAY:
    "This customer is not assigned to you, please contact your admin.",
  ...
  CUSTOMER_DEACTIVATE_ADD_MODIFY_DOCUMENT:
    "Customer is deactivate. You can not add/modify document",
