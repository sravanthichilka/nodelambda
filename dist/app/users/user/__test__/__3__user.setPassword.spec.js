...
describe("User Suit (POST /user/setPassword)", () => {
    ...
    describe("Logged in from Superadmin", () => {
        it("Correct credentails, set propery setTemporaryPassword 1,  superadmin@yopmail.com, httpcode #200", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            users_repo_1.default.updateUser(user.id, { setTemporaryPassword: 1 });
            const updatePasswordClone = Object.assign({}, updatePassword);
        ...
        it("Correct credentails, set propery setTemporaryPassword 0,  superadmin@yopmail.com, httpcode #403", () => __awaiter(void 0, void 0, void 0, function* () {
            const updatePasswordClone = Object.assign({}, updatePassword);
            const result = yield supertest_1.default(main_1.default)
                .patch("/user/setPassword")
                .set("user-agent", "mocha")
    ...
    describe("Logged in from admin", () => {
        it("Correct credentails, set propery setTemporaryPassword 1,  admin@yopmail.com, httpcode #200", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("dont send field, admin@yopmail.com, httpcode #422", () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield supertest_1.default(main_1.default)
                .patch("/user/setPassword")
                .set("user-agent", "mocha")
                .set("Authorization", ADMIN_ACCESS_TOKEN)
    ...
    describe("Logged in from teammember", () => {
        it("Correct credentails, set propery setTemporaryPassword 1,  teammember@yopmail.com, httpcode #200", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("Correct credentails, set propery setTemporaryPassword 0,  teammember@yopmail.com, httpcode #403", () => __awaiter(void 0, void 0, void 0, function* () {
            const updatePasswordClone = Object.assign({}, updatePassword);
            const result = yield supertest_1.default(main_1.default)
                .patch("/user/setPassword")
                .set("user-agent", "mocha")
        ...
        it("dont send field, teammember@yopmail.com, httpcode #422", () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield supertest_1.default(main_1.default)
                .patch("/user/setPassword")
                .set("user-agent", "mocha")
                .set("Authorization", TEAMMEMBER_ACCESS_TOKEN)
    ...
    describe("Logged in from customer", () => {
        it("Correct credentails, set propery setTemporaryPassword 1,  customer@yopmail.com, httpcode #200", () => __awaiter(void 0, void 0, void 0, function* () {
            const condition = { email: helper_1.roleLoginCredentails.customer.credentails.email };
            const user = yield users_repo_1.default.searchUser(condition);
            users_repo_1.default.updateUser(user.id, { setTemporaryPassword: 1 });
            const updatePasswordClone = Object.assign({}, updatePassword);
            const result = yield supertest_1.default(main_1.default)
        ...
        it("Correct credentails, set propery setTemporaryPassword 0,  customer@yopmail.com, httpcode #403", () => __awaiter(void 0, void 0, void 0, function* () {
            const updatePasswordClone = Object.assign({}, updatePassword);
            const result = yield supertest_1.default(main_1.default)
                .patch("/user/setPassword")
                .set("user-agent", "mocha")
        ...
        it("dont send field, customer@yopmail.com, httpcode #422", () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield supertest_1.default(main_1.default)
                .patch("/user/setPassword")
                .set("user-agent", "mocha")
                .set("Authorization", CUSTOMER_USER_ACCESS_TOKEN)
