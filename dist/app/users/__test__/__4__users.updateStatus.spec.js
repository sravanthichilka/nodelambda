...
describe("Users Suit  (PATCH /users/:userId/status)", () => {
    ...
    describe("Logged in from Superadmin", () => {
        it("update status user inactive #13 , httpcode #200", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            addUpdateUserClone.status = constants_1.ENUM_User_Status.INACTIVE;
        ...
        it("update status user active #13 , httpcode #200", () => __awaiter(void 0, void 0, void 0, function* () {
            const addUpdateUserClone = Object.assign({}, updateUserStatus);
            addUpdateUserClone.status = constants_1.ENUM_User_Status.ACTIVE;
            const result = yield supertest_1.default(main_1.default)
                .patch("/users/13/status")
                .set("user-agent", "mocha")
                .set("Authorization", SUPERADMIN_ACCESS_TOKEN)
    ...
    describe("Logged in from admin", () => {
        it("update status user inactive add_user_a_team@yopmail.com , httpcode #200", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("update status user active add_user_a_team@yopmail.com , httpcode #200", () => __awaiter(void 0, void 0, void 0, function* () {
            const addUpdateUserClone = Object.assign({}, updateUserStatus);
            addUpdateUserClone.status = constants_1.ENUM_User_Status.ACTIVE;
            const condition = { email: "add_user_a_team@yopmail.com" };
            const user = yield users_repo_1.default.searchUser(condition);
    ...
    describe("Logged in from teammember", () => {
        it("update status user inactive #13 , httpcode #403", () => __awaiter(void 0, void 0, void 0, function* () {
            const addUpdateUserClone = Object.assign({}, updateUserStatus);
            addUpdateUserClone.status = constants_1.ENUM_User_Status.INACTIVE;
            const result = yield supertest_1.default(main_1.default)
                .patch("/users/13/status")
        ...
        it("update status user active #13 , httpcode #403", () => __awaiter(void 0, void 0, void 0, function* () {
            const addUpdateUserClone = Object.assign({}, updateUserStatus);
            addUpdateUserClone.status = constants_1.ENUM_User_Status.ACTIVE;
            const result = yield supertest_1.default(main_1.default)
                .patch("/users/13/status")
