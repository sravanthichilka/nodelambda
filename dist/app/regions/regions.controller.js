...
const regions_repo_1 = __importDefault(require("./regions.repo"));
    ...
    fetchRegionTypes(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                sqlQueryParams.push(constants_1.ENUM_REGION_STATUS.ACTIVE);
                let sqlQueryBuilder = sqlQuery.join(" and ");
                let sqlQueryBuilderList = sqlQueryParams;
                let documentTypesList = yield regions_repo_1.default.getRegionFetchList(sqlQueryBuilder, sqlQueryBuilderList, { sortObject, pageLimit: pageLimitObj });
                const data = {
